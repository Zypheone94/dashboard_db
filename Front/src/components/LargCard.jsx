...
import '../styles/LargCard.scss'

const LargCard = () => {
  return (
    <section id='larg_card'>
        <div id='larg_card_header'>
          <h3>Title</h3>
          <div id="larg_card_link">
            <p>See something</p>
        ...
        <div id='larg_card_body'>
          <div id='larg_card_body_left'>
            <h3>Value</h3>
            <p>Content</p>
          </div>
          <div id='larg_card_body_right'>
            <h3>Value</h3>
            <p>Content</p>
          </div>
        </div>
